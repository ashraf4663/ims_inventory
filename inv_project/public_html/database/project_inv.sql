...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2021 at 09:57 AM
...
(18, 1, 'MOBILE', '1'),
(19, 5, 'itel', '1'),
(20, 15, 'Editing Data', '1'),
(21, 15, 'Software Editor', '1'),
(46, 15, 'Editing Software', '1'),
(47, 13, 'Laptop', '1'),
(50, 0, 'Men\'s Shirt', '1'),
(64, 0, 'TEST', '1'),
(65, 0, 'TEST1', '1'),
...
(19, 9, 18, 'Avira 1 PC Security', 600, 10, '2020-10-01', '1'),
(21, 47, 13, 'A4 tech', 600, 10, '2020-10-01', '1'),
(25, 9, 18, 'Avira Security ', 600, 10, '2020-10-01', '1');
...
(15, 'testtest', 'test@gmail.com', '$2y$08$qJnnn.0oOj1anNuBdEVk3.Mqv9Z41ioJsoGpUJ3e5gzgLlChR1hqO', 'Admin', '2020-09-22', '2020-09-22 00:00:00', ''),
(16, 'rizwan', 'rizwan@gmail.com', '$2y$08$4Mo2frukCKB/DqZtNAanDOWpVxendxLVKDJy.dhX97pongkXp4b5a', 'Admin', '2020-09-22', '2020-09-22 00:00:00', ''),
(17, 'rizwan', 'rizwan1@gmail.com', '$2y$08$8LXwftL.xqUt9LLnnmfIeu0oZk4KjNcdQ9QCqED68nj5ls3t29Amq', 'Admin', '2020-09-22', '2020-09-22 05:09:11', ''),
(18, 'ashraf', 'ashraf@gmail.com', '$2y$08$Crn2zJiiVdiT0lMExXSLUOnSFeClyAIGLDfD2kNc.Hixd4EcI8DHq', 'Admin', '2020-09-22', '2020-11-17 01:11:46', ''),
(19, 'khan', 'khan@gmail.com', '1234567890', 'Admin', '2020-09-27', '2020-09-27 00:00:00', ''),
(20, 'johof', 'johof@gmail.com', '$2y$08$JiGrsoOagiwUbeuyRaSoGedLxG8enfIbV6WnNxkO1jnnmPFDQJDfO', 'Admin', '2020-09-27', '2020-09-27 00:00:00', ''),
(21, 'johof', 'johofdw@gmail.com', '$2y$08$xLblfrbHIy9fA.seaBOOyuOaFDJ/nAfd1WzW4oJtnIsKpf66fvItu', 'Admin', '2020-10-14', '2020-10-14 00:00:00', '');
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`cid`) REFERENCES `categories` (`cid`),
  ADD CONSTRAINT `product_ibfk_2` FOREIGN KEY (`bid`) REFERENCES `brands` (`bid`);
