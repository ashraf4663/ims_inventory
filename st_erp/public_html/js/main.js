$(document).ready(function(){
	var DOMAIN = "http://localhost/st_erp/public_html";
	$("#register_form").on("submit",function(){
		...
		if(pass2.val() != pass1.val()){
			...
			$("#p2_error").html("<span class='text-danger'>Please Enter Same password</span>");
			status = false;
		}else{
		...
		if(type.val() == ""){
			...
			$("#t_error").html("<span class='text-danger'>Please Select a UserType Option</span>");
			status = false;
		}else{
