...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2021 at 11:06 PM
...
(46, 'cash', '0000-00-00', 900, 162, 0, 1062, 1000, 62, 'Cash'),
(47, 'cash', '2020-12-02', 65400, 9810, 0, 75210, 20000, 55210, 'Cash');
...
(40, 46, 'Denim Man\'s Shirt', 400, 1),
(41, 46, 'Avira Antivirus', 500, 1),
(42, 47, 'Iphone 8', 65000, 1),
(43, 47, 'Denim Man\'s Shirt', 400, 1);
...
(17, 5, 17, 'Iphone 8', 65000, 1191, '2018-01-31', '1'),
(18, 9, 18, 'Avira Antivirus', 500, 2989, '2018-01-31', '1'),
(19, 12, 19, 'Denim Man\'s Shirt', 400, 25, '2020-11-28', '1'),
(20, 12, 19, 'Man\'s Formal Shirt', 350, 100, '2020-11-28', '1'),
(21, 12, 20, 'Formal Shirt Mans', 350, 50, '2020-12-02', '1'),
(22, 14, 22, 'Twinkel', 120, 20, '2020-12-02', '1');
...
(1, 'Rizwan', 'rizwan@gmail.com', '$2y$08$s11k9wKZWc4v6apSODUdveJufFxbE2Be7rP./uS49et7NrlhteFgK', 'Admin', '2017-12-23', '0000-00-00 00:00:00', ''),
...
(8, 'Ashraful Islam', 'ashraf@gmail.com', '$2y$08$NbcT8CI/Ae6mDer9BY8Hae9MeyVgatFJoOJKvpcrvwAQOmDQrt/uO', 'Admin', '2020-11-24', '2020-12-22 12:12:04', ''),
(9, 'johofdw', 'johof@gmail.com', '$2y$08$coMEzKJt0N/QlfIsQMojSOI5rQi8AGSHZLoj4mOwVpdEqoBH0c//e', 'Other', '2020-11-27', '2020-11-27 11:11:07', ''),
(10, 'faisal', 'faisal@gmail.com', '$2y$08$TYA6OBMOSJnpReWgxnV81Ohp36l32LOYys/VnPkusLnf7WqCDWKxe', 'Other', '2020-11-27', '2020-11-27 00:00:00', ''),
(11, 'Aslam', 'aslam@gmail.com', '$2y$08$tcV/nHx3DuonbMoHqzr5C.WhVwQjhPZf2pXhlNe5neZ.dKFmNPgr.', 'Other', '2020-11-27', '2020-11-27 11:11:49', ''),
(12, 'ashadul', 'ashad@gmail.com', '$2y$08$V8F92rbr/2wlBThgnCt08.D09NFPiKVA.vg/mQYINgfj1s4YsHZPK', 'Other', '2020-11-27', '2020-11-27 00:00:00', '');
...
--
ALTER TABLE `invoice`
  MODIFY `invoice_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`cid`) REFERENCES `categories` (`cid`),
  ADD CONSTRAINT `customers_ibfk_2` FOREIGN KEY (`id`) REFERENCES `invoice_details` (`id`),
  ADD CONSTRAINT `customers_ibfk_3` FOREIGN KEY (`invoice_no`) REFERENCES `invoice` (`invoice_no`);
